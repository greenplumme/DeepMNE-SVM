...
def load_emb_yeast():
	...
	coexpression_emb = read_embeding('./emb/yeast_coexpression_SGD_0.5_new.txt')
	cooccurence_emb = read_embeding('./emb/yeast_cooccurence_SGD_0.5_new.txt')
	database_emb = read_embeding('./emb/yeast_database_SGD_0.5_new.txt')
	experimental_emb = read_embeding('./emb/yeast_experimental_SGD_0.5_new.txt')
	fusion_emb = read_embeding('./emb/yeast_fusion_SGD_0.5_new.txt')
	neighborhood_emb = read_embeding('./emb/yeast_neighborhood_SGD_0.5_new.txt')
...
def load_emb_human():
	coexpression_emb = read_embeding_human('./emb/human_coexpression_SGD_0.5_new.txt')
	cooccurence_emb = read_embeding_human('./emb/human_cooccurence_SGD_0.5_new.txt')
	database_emb = read_embeding_human('./emb/human_database_SGD_0.5_new.txt')
	experimental_emb = read_embeding_human('./emb/human_experimental_SGD_0.5_new.txt')
	fusion_emb = read_embeding_human('./emb/human_fusion_SGD_0.5_new.txt')
	neighborhood_emb = read_embeding_human('./emb/human_neighborhood_SGD_0.5_new.txt')
